# Ablation: w/o dropout of context

mask=True
attr="CEL-C10D5-nodropout"
...
for dictionary_mask_rate_curriculum in "off"
do
...
sbatch -J $job_name scripts/train_im_ICLDR_baseWD_long.sh \
    $attr \
    $train_ds_IM \
    $test_ds_IM \
    $save_freq \
