...
class TrainingArguments(TA):
    ...
    weight_decay_pretrained: Optional[float] = field(
        default=0.0,
        metadata={"help": "Weight decay for pretrained layers"}
    )

@dataclass
class DataArguments:
    #dataset to train on
    train_path_IM: Optional[str] = field(
        default='',
        metadata={"help": " Path to the dataset"}
    )
    
    eval_path_IM: Optional[str] = field(
        default='',
        metadata={"help": " Path to the dataset"}
    )

    train_path_ICL: Optional[str] = field(
        default='',
        metadata={"help": " Path to the dataset"}
    )
    
    eval_path_ICL: Optional[str] = field(
        default='',
        metadata={"help": " Path to the dataset"}
    )
    ...
    train_n_textbook_ICL: Optional[int] = field(
        default=1000,
        metadata={"help": "Number of textbooks in training"}
    )

    train_n_sample_ICL: Optional[int] = field(
        default=10000,
        metadata={"help": "Number of samples in training"}
    )

    eval_n_textbook_ICL: Optional[int] = field(
        default=1000,
        metadata={"help": "Number of textbooks in testing"}
    )

    eval_n_sample_ICL: Optional[int] = field(
        default=10000,
        metadata={"help": "Number of samples in testing"}
    )

    train_n_textbook_IM: Optional[int] = field(
        default=1000,
        metadata={"help": "Number of textbooks in training"}
    )

    train_n_sample_IM: Optional[int] = field(
        default=10000,
        metadata={"help": "Number of samples in training"}
    )

    eval_n_textbook_IM: Optional[int] = field(
        default=1000,
        metadata={"help": "Number of textbooks in testing"}
    )

    eval_n_sample_IM: Optional[int] = field(
        default=10000,
        metadata={"help": "Number of samples in testing"}
    )
    ...
    icl_im_datamix: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to mix data from ICL into IM"}
    )

    fake_dictionary: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to use fake dictionaries"}
    )
